...
[ApiController]
[Route("api")]using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using TaskManager.Data;
using TaskManager.Models;
...
public class TaskController : ControllerBase
{
    ...
    // FIXED: CreateTask now uses status from request body
    [HttpPost("tasks")]
    public async Task<IActionResult> CreateTask([FromBody] TaskItem taskItem)
    {
        ...
        // FIXED: Use status from request, default to 'pending' if not provided
